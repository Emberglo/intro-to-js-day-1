...
// Write a function that will capitalize the letter at a given position and return the capital letter
function capitalizer(str, position) {
	// split = str.split('');
	// for (let i = 0; i < str.length; i++) {
	// 	split[position] = split[position].toUpperCase();
	// }
	// let string = split.join('');
	// console.log(string);
	// return string;
	let split = str.split('');
	return split[position].toUpperCase();
}
